...
namespace Nightfall.UnityMvp.Editor
{
    public sealed class NightfallUiPreview:EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Space(10);if(GUILayout.Button("Validate active UI",GUILayout.Height(34))){var game=Game();auditResult=game!=null?game.RunUiLayoutAudit():"NightfallGame not found";}EditorGUILayout.HelpBox(auditResult,MessageType.None);
